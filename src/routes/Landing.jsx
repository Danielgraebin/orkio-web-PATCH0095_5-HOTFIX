        ...
        <div className="grid items-start gap-10 md:grid-cols-2">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/75">
              <span className="inline-flex h-2 w-2 rounded-full bg-cyan-300 shadow-[0_0_0_6px_rgba(53,208,255,0.12)]" />
              Orkio is live — evolving into Phase 2
            </div>          <div className="mb-6 flex justify-center">
            <img src="/orkio-logo.png" alt="Orkio" className="h-20 w-auto" />
          </div>
      ...
      <footer className="border-t border-white/10 bg-black/10">
        <div className="mx-auto max-w-6xl px-4 py-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            ...
            <img src="/orkio-logo.png" alt="Orkio" className="h-11 w-auto" />
              <div>
                <div className="font-extrabold tracking-wide">ORKIO</div>
                <div className="text-xs text-white/60">Autonomous Intelligence Core</div>
              </div>
            </div>
          ...
          <div className="mt-6 text-xs text-white/50">© {new Date().getFullYear()} Orkio Intelligence Systems.</div>
        </div>
      </footer>
    </div>
  );
